...
test_images = X_test[:10].reshape(-1, X_test.shape[1], X_test.shape[2])
...
# Display incorrect predictions
display_incorrect_predictions(X_test.reshape(-1, X_test.shape[1], X_test.shape[2]), y_true, y_pred, ['Rain', 'Likely to Rain', 'No Rain'])

# Histograms of predicted probabilities
def plot_predicted_probabilities(X_test, y_test, cnn_model):
...
plot_predicted_probabilities(X_test, y_test, cnn_model)
